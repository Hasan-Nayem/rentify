    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            <a href="{{ route('backend.cms.index') }}">
                <div class="parent-icon"><i class="bi bi-layout-text-window"></i>
                </div>
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route('profile.index') }}"><i class="bi bi-circle"></i>Profile</a>
                </li>
                <li> <a href="{{ route('system.index') }}"><i class="bi bi-circle"></i>System</a>
                </li>
                <li> <a href="{{ route('mail.index') }}"><i class="bi bi-circle"></i>Mail</a>
                </li>
            </ul>
        </li>
    </ul>
