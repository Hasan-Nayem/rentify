...
<div class="no-bottom no-top" id="content">
    <div id="top"></div>
    <section id="section-hero" aria-label="section" class="full-height vertical-center" data-bgimage="url(https://www.madebydesignesia.com/themes/rentaly/images/background/7.jpg) bottom">
        <div class="container">
    ...
    <section id="section-img-with-tab" data-bgcolor="#f8f8f8">
        ...
        <div class="image-container col-md-6 pull-right" data-bgimage="url(https://www.madebydesignesia.com/themes/rentaly/images/background/5.jpg) center"></div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="de-image-text">
                        ...
                        <img src="{{ asset('/frontend/images/testimonial/1.jpg') }}" class="img-fluid" alt="">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="de-image-text">
                        ...
                        <img src="{{ asset('/frontend/images/testimonial/2.jpg') }}" class="img-fluid" alt="">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="de-image-text">
                        ...
                        <img src="{{ asset('/frontend/images/testimonial/3.jpg') }}" class="img-fluid" alt="">
                    </div>
                </div>
